# Canonical structure: book -> list of (chapter_num, verse_count)
...
BIBLE_STRUCTURE = {
    ...
    "Hosea": [(1, 11), (2, 23), (3, 5), (4, 19), (5, 15), (6, 11), (7, 16), (8, 14), (9, 17), (10, 15), (11, 11), (12, 14), (13, 16), (14, 9)],
    "Joel": [(1, 20), (2, 32), (3, 21)],
...
def get_all_book_names():
    return list(BIBLE_STRUCTURE.keys())
